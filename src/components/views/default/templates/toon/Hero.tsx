    ...
    >
      <div className="max-w-3xl">
        ...
        <div className="mt-10 flex flex-wrap items-center gap-3">
          <a
            href="#projects"
            className="toon-btn inline-flex items-center gap-2 bg-accent px-7 py-3 text-sm font-black text-background"
          >
            {t.default.hero.viewProjects} <span aria-hidden>→</span>
          </a>
          <a
            href="#contact"
            className="toon-btn inline-flex items-center gap-2 bg-card px-7 py-3 text-sm font-bold text-foreground hover:text-accent"
          >
