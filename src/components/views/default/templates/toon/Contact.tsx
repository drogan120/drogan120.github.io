...
export default function ToonContact() {
  const { t } = useI18n();

  return (
    <Section id="contact">
      <div className="toon-frame relative overflow-hidden bg-card px-6 py-16 text-center sm:px-12 sm:py-20">
        <div className="relative">
          <p className="toon-shadow font-mono text-xs tracking-[0.3em] text-accent uppercase">
            {t.default.contact.label.replace("// ", "")}
          </p>

          <h2 className="toon-shadow mt-5 text-3xl leading-tight font-black tracking-tight sm:text-5xl">
