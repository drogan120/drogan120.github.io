...
function Stat({
  ...
  return (
    <div className="ff7-frame relative bg-card px-6 py-8 text-center">
      <span className="text-xl">{icon}</span>
      <p className="ff7-glow mt-3 text-4xl font-black tabular-nums text-accent sm:text-5xl">
        {parsed ? (
          <>
...
export default function Ff7Stats() {
  const { t } = useI18n();
