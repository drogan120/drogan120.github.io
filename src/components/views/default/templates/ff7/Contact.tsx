...
export default function Ff7Contact() {
  const { t } = useI18n();

  return (
    <Section id="contact">
      <div className="ff7-frame relative overflow-hidden bg-card px-6 py-16 text-center sm:px-12 sm:py-20">
        <span
          aria-hidden
        ...
        <div className="relative">
          <p className="ff7-glow font-mono text-xs tracking-[0.3em] text-accent uppercase">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <a
              ...
              className="ff7-glow inline-flex items-center gap-2 border border-accent bg-accent px-6 py-3 text-sm font-bold text-background transition-transform hover:scale-[1.03]"
            >
              {t.default.nav.hire} →
            </a>
            <DownloadResume />
