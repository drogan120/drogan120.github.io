    ...
    <section id="gallery" className="mx-auto max-w-5xl px-6 py-16 md:py-24">
      ...
      <div className="mt-12 grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-4">
        {t.default.gallery.items.map((item) => (
          <div
            key={item.title}
            className="flex flex-col items-center gap-3 rounded-3xl bg-gradient-to-br from-accent/5 to-accent-2/5 p-5 ring-1 ring-border/60 transition-transform hover:-translate-y-1"
          >
