  ...
  return (
    <section id="contact" className="mx-auto max-w-5xl px-6 py-24">
      <div className="rounded-[2.5rem] bg-gradient-to-br from-pink-100/60 via-purple-100/60 to-sky-100/60 p-12 text-center sm:p-16 dark:from-pink-500/10 dark:via-purple-500/10 dark:to-sky-500/10">
        ...
        <h2 className="mt-3 text-4xl font-bold text-slate-700 dark:text-slate-100">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          {links.map((link) => (
            <a
              ...
              className="rounded-full bg-white px-7 py-3 font-medium text-slate-600 shadow-sm ring-1 ring-slate-200 transition-transform hover:scale-105 dark:bg-white/10 dark:text-slate-300 dark:ring-white/10"
            >
              {link.label}
            </a>
          ))}
