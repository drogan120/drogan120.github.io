...
export default function NeonContact() {
  ...
  return (
    <Section id="contact">
      <div className="relative overflow-hidden rounded-2xl border border-border bg-card/80 px-6 py-16 text-center shadow-[0_0_32px_-12px_var(--accent)] sm:px-12 sm:py-20">
        <span
          aria-hidden
        ...
        <div className="relative">
          ...
          <h2 className="neon-text-soft mx-auto mt-5 max-w-2xl text-3xl leading-tight font-bold tracking-tight sm:text-5xl">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-md bg-accent px-6 py-3 text-sm font-bold text-background shadow-[0_0_24px_-6px_var(--accent)] transition-transform hover:scale-[1.03]"
            >
              {t.default.nav.hire} →
            </a>
            <DownloadResume />
