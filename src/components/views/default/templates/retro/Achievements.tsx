    ...
    <Section id="achievements">
      ...
      <div className="mt-12 grid gap-4 sm:grid-cols-3">
        {t.default.achievements.items.map((item, i) => (
          <article
            key={item.title}
            className="group relative overflow-hidden rounded-lg border border-accent/30 bg-card/80 p-6 shadow-[0_0_24px_-14px_var(--accent)] transition-transform duration-500 hover:-translate-y-1 sm:p-7"
          >
            <span
              aria-hidden
