...
function Stat({
  ...
  return (
    <div className="relative px-6 py-8 text-center">
      ...
      <p className="mt-3 font-serif text-5xl font-bold tabular-nums text-accent sm:text-6xl">
        {parsed ? (
          <>
...
export default function PaperStats() {
  ...
  return (
    <Section>
      <div
        ref={ref}
        className="paper-frame grid divide-y divide-border overflow-hidden rounded-md bg-card sm:grid-cols-3 sm:divide-x sm:divide-y-0"
      >
