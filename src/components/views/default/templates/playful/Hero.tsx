  ...
  return (
    <section id="top" className="relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -top-10 right-1/4 h-72 w-72 rounded-full bg-accent-2/20 blur-[100px]" />
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center px-6 pt-28 pb-24 text-center">
        <span className="mb-6 rounded-full border border-accent/30 bg-accent/10 px-4 py-1.5 text-sm font-medium text-accent">
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
          <a
            href="#projects"
            className="rounded-2xl bg-gradient-to-r from-accent to-accent-2 px-8 py-3.5 font-semibold text-background shadow-lg shadow-accent/30 transition-all hover:scale-105 hover:shadow-accent/50"
          >
            {t.default.hero.viewProjects} →
          </a>
          <a
            href="#contact"
            className="rounded-2xl border-2 border-border px-8 py-3.5 font-semibold text-foreground transition-all hover:border-accent hover:text-accent"
          >
