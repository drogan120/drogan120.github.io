...
export default function AnimeGithub() {
  const { t } = useI18n();
  ...
  return (
    <Section id="github">
      ...
      <a
        ...
        className="mt-8 inline-flex items-center gap-2 rounded-lg border-2 border-border bg-card px-5 py-2.5 font-mono text-sm transition-colors hover:border-accent hover:text-accent"
      >
